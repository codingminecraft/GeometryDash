...
public class AssetPool {
    ...
    public static Spritesheet getSpritesheet(String pictureFile) {
        ...
        if (AssetPool.hasSpritesheet(file.getAbsolutePath())) {
            ...
            System.out.println("Spritesheet '" + pictureFile + "' has not been added to asset pool.");
            System.exit(-1);
        }
        return null;
    }
    ...
    private static void addSprite(String pictureFile, Sprite sprite) {
        File file = new File(pictureFile);
        AssetPool.sprites.put(file.getAbsolutePath(), sprite);
    }

    private static void addSpritesheet(String pictureFile, Spritesheet spritesheet) {
        File file = new File(pictureFile);
